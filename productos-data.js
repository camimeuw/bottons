  ...
  fetch(SHEETS_URL, { cache: "no-store" })
    ...
    .catch(() => {
      ...
      PRODUCTOS = [
        ...
        { id: 5, nombre: "Peluche Minecraft", precio: "Gs. 6.000", color: "#ffb3d1", detalle: "20cm, bordado, edición limitada.", categoria: "Minecraft and stuff", subcategoria: "Peluches", talles: "", stock: 0, destacado: true },
        { id: 6, nombre: "Carcasa Horror Game", precio: "Gs. 5.000", color: "#ffd6ea", detalle: "Compatible iPhone y Android.", categoria: "Minecraft and stuff", subcategoria: "Carcasas", talles: "", stock: 8, destacado: false }
      ];
      window.dispatchEvent(new Event('productosLoaded'));
    });
})();

const CATEGORIAS_TIENDA = ["Alt & Y2K", "Soft & Polka Dots", "Vintage & 2nd Hand", "Midwest & Grunge", "Conjuntos Completos", "Minecraft and stuff"];
...
const SUBCATEGORIAS_TIENDA = {
  ...
  "Minecraft and stuff": ["Coleccionables", "DVD's", "Merch", "Frazadas", "Tapices decorativos", "Objetos decorativos", "Peluches", "Llaveros", "Carcasas"]
};
