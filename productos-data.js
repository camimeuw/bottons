const PRODUCTOS = [
  { id: 1, nombre: "Top Y2K Estrella", precio: "$8.000", color: "#ffa0cd", detalle: "Talles: S, M, L. Tela stretch, corte cropped.", categoria: "Alt & Y2K", subcategoria: "Tops/mangas largas/remeras" },
  ...
  { id: 3, nombre: "Minifalda Soft", precio: "$10.000", color: "#fc81b4", detalle: "Talles: S, M. Tiro alto, lazo lateral.", categoria: "Soft & Polka Dots", subcategoria: "Minifaldas" },
  { id: 4, nombre: "Bolso Grunge", precio: "$12.000", color: "#f963af", detalle: "Cuerina negra, correa ajustable.", categoria: "Midwest & Grunge", subcategoria: "Bolsos" },
  { id: 5, nombre: "Peluche Minecraft", precio: "$6.000", color: "#ff82b2", detalle: "20cm, bordado, edición limitada.", categoria: "Coleccionables y Otros", subcategoria: "Peluches" },
  { id: 6, nombre: "Carcasa Horror Game", precio: "$5.000", color: "#fc81b4", detalle: "Compatible iPhone y Android.", categoria: "Coleccionables y Otros", subcategoria: "Carcasas" }
];
